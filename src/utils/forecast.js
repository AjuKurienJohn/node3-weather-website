...
const forecast = (latitude, longitude, callback) => {
    ...
    request({url, json: true}, (error, { body }) => {
        if (error) 
            ...
            callback (undefined, 
                `${body.daily.data[0].summary}<br>
                It is currently ${body.currently.temperature} degrees out.<br> 
                The temperature range for today is ${body.daily.data[0].temperatureLow} to ${body.daily.data[0].temperatureHigh}.<br>
